 ...
 implements corba.CorbaFrontEndOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("helloPlatform", new java.lang.Integer (0));
    _methods.put ("validateScript", new java.lang.Integer (1));
    _methods.put ("startAgent", new java.lang.Integer (2));
    _methods.put ("listActiveAgents", new java.lang.Integer (3));
    _methods.put ("listAvailableReports", new java.lang.Integer (4));
    _methods.put ("getAgentReport", new java.lang.Integer (5));
    _methods.put ("getHostReport", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // corba/CorbaFrontEnd/helloPlatform
       {
       ...
       case 1:  // corba/CorbaFrontEnd/validateScript
       {
         try {
       ...
       case 2:  // corba/CorbaFrontEnd/startAgent
       {
         String script = in.read_string ();
       ...
       case 3:  // corba/CorbaFrontEnd/listActiveAgents
       {
         try {
           String $result = null;
       ...
       case 4:  // corba/CorbaFrontEnd/listAvailableReports
       {
         try {
           String $result = null;
       ...
       case 5:  // corba/CorbaFrontEnd/getAgentReport
       {
         try {
       ...
       case 6:  // corba/CorbaFrontEnd/getHostReport
       {
         try {
           int idx = in.read_long ();
           String $result = null;
