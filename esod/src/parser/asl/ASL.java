...
public class ASL/*@bgen(jjtree)*/implements ASLTreeConstants, ASLConstants {/*@bgen(jjtree)*/
 ...
 /*@bgen(jjtree) AgentDefinitionNode */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);Token scriptID = null;
        Token author = null;
        Token date = null;
        Token comment = null;
        Token obs = null;
 ...
 /*@bgen(jjtree) ReportNode */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);Token report = null;
        Token email = null;
        Token smtp = null;
        Token host = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case REPORTCALLBACK:
        report = jj_consume_token(REPORTCALLBACK);
        break;
      case REPORTNOW:
        report = jj_consume_token(REPORTNOW);
        break;
      case REPORTMAIL:
        report = jj_consume_token(REPORTMAIL);
        email = jj_consume_token(EMAIL);
        jj_consume_token(SMTP);
        smtp = jj_consume_token(HOSTNAME);
        break;
      case REPORTFINAL:
        report = jj_consume_token(REPORTFINAL);
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case HOSTNAME:
 ...
 /*@bgen(jjtree) OutputNode */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);Token output = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OUTPUTCALLBACK:
        output = jj_consume_token(OUTPUTCALLBACK);
        break;
      case OUTPUT:
 ...
 /*@bgen(jjtree) InputNode */
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x2e00000,0x2000,0x8000,0x150000,0xee00000,0xee00000,0x20000,0x0,0x80000,0x150000,0x0,0x2e00000,0xc000000,0x0,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x4000,0x0,0x0,0x400,};
   }
