...
public class AgentImpl implements Agent, Cloneable {
	 ...
	 * 
	 * @param host			defines the agent location
	 */
	...
	/**
	 * starts and preforms all the actions specified in the script
	 * in a particular host. Each action, it's output and a timestamp
	 * are recorded in the agent and sent to a well known repository
	 * for future viewing.
	 * 
	 ...
	 * script atributed to the agent, including:
	 * 	author;
	 *	date;
	 *	comment;
	 *	observations;
	...
	/**
	 * sets the private member mediator
	 * of the agent to the variable m
	 * 
	 * @param				reference to a mediator object
	 */
	 ...
	 * 
	 * @param host			sets the agent new location
	 */
	...
	/**
	 * returns the reference of the object repository
	 * known by the agent
	 * 
	 ...
	 * 
	 * @param r				remote reference to be set
	 */
	 ...
	 * 
	 * @param home			agent home to be set
	 */
	...
	/**
	 * creates a LinkedList with the reports
	 * of the agent from all the visited nodes
	 * 
	 ...
	 * of the hosts that the agent as visited
	 * 
	...
	/**
	 * returns the report created by the agent 
	 * in the last visited node
	 * 
